...
- **Email通知システム**: SNS経由でgeeknow112@gmail.comに通知
...
| サーバー名 | ドメイン | パス | 通知状況 |
|-----------|---------|------|---------|
| Server-001 (YC2) | ycstg.lober-env-imp.work | / | ✅ 受信確認済み |
| Server-002 (YC3) | yamachu.lober-env-imp.work | / | ✅ 受信確認済み |
| Server-003 (Keepa) | ycstg.lober-env-imp.work | / | ✅ 受信確認済み |
| Server-004 (DBC) | dbc.47club.co.jp | /wp-login.php | ❌ 未受信 |
| Server-005 (Labor-Hack) | hack-note.com | / | ✅ 受信確認済み |
...
## 🔗 関連リソース
- **GitHubリポジトリ**: https://github.com/geeknow112/cloudwatch-monitoring
